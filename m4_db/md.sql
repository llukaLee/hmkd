...
--과제6_0508. 가격이 20000원인 도서를 주문한 고객의 이름과 도서의 이름을 구하시오.
select c.name, b.bookname 
from customer c, orders o, book b 
...
--과제6_0509. 각 고객의 평균 주문금액보다 큰 금액의 주문 내역에 대해서 주문번호, 고객번호, 금액을 보이시오.
...
from customer c, orders o
where exists ( select address from customer where address like '%대한민국%' and c.custid=o.custid);
